...
class __TwigTemplate_6fdd8a951ec61363e3bc02c910d3545383233cc87b7ae6a5535371fbc8a27ce7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["register"]) || array_key_exists("register", $context) ? $context["register"] : (function () { throw new RuntimeError('Variable "register" does not exist.', 8, $this->source); })()), 'form');
        echo "
    </div>
";
...
{% endblock %}
", "register/index.html.twig", "/var/www/symfony-project/templates/register/index.html.twig");
    }
}
